...
class bacon_cipher:
    ...
    def Bacon_encode(self, file: str, message: str) -> str:
        ...
        split_obj = xml_parse.XML_split(
            pattern_string, file, "bacon", "default")
    ...
    def Bacon_decode(self, file: str) -> str:
        ...
        for paragraph in doc.paragraphs:
            ...
            for run in paragraph.runs:
                ...
                if (end_of_message == 5):
                    break
                # pro kódování a dekódování Baconovou šifrou nepracuji s bílými znaky
                # (pro práci s nimi je implementována jiná metoda)
                t = run.text
                split = t.strip().split(" ")
...
def add_bacon_style(font_styles: str) -> None:
    ...
    if not custom_style_present:
        font_charstyle = font_styles.add_style(
            'baconstyle', WD_STYLE_TYPE.CHARACTER)
